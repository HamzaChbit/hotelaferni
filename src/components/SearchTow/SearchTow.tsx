...
const handleFilterClick = () => {
  ...
  return (
    <section  className=' md:mt-20 mt-5 rounded-lg mb-5   ' >
        <div className='flex gap-4 flex-wrap justify-between items-center   md:px-10 px-2  py-8 rounded-lg border-2 border-tertiary-dark ' >
            <div className='w-full  lg:w-auto mb-4 md:mb-0' >
          ...
          <div className='relative'>
           ...
           onChange={handleRoomTypeChange}
            ...
            >
              ...
              <option value='double room'>{t("twin")}</option>
               <option value='triple room'>{t("triple")}</option>        
